...
public class EcommAppApplication {
    ...
    CommandLineRunner start(ProductRepository productRepository){
        return args -> {
            productRepository.save(new Product(1L,"Ord HP 564",8000.0));
            productRepository.save(new Product(2L,"Imprimante LX 11",100.0));
            productRepository.save(new Product(3L,"Smart phone Sumsung s20",9900.0));
